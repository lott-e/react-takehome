...
export default function Page() {
  ...
  const handleClick = () => {
    ...
    link.setAttribute('href', ref.current.screenshot)
    link.click()
  }
    ...
    <>
      ...
      <div className='mx-auto flex w-full flex-col flex-wrap items-center px-12 md:flex-row lg:w-4/5'>
        <div className='relative h-96 w-full py-8 sm:w-1/2'>
          <View ref={ref} orbit className='relative h-full sm:w-full'>
          ...
          {/* need third Canvas to take pictures of others? */}
          {/* <View ref={ref} orbit className='relative h-full sm:w-full'></View> */}
        </div>
